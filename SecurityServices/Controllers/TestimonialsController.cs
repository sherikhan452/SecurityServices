...
namespace SecurityServices.Controllers
{
    public class TestimonialsController : Controller
    {
        ...
        public TestimonialsController(ApplicationContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,ClientName,Message,Date")] Testimonial testimonial)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ClientName,Message,Date")] Testimonial testimonial)
        {
