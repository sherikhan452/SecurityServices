...
{
    public class ServicesDBController : Controller
    {
        private readonly ApplicationContext _context;

        public ServicesDBController(ApplicationContext context)
        {
            _context = context;
        }
        ...
        // GET: ServicesDB/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: ServicesDB/Create
