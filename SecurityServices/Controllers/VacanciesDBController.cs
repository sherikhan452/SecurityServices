...
namespace SecurityServices.Controllers
{
    public class VacanciesDBController : Controller
    {
        ...
        public VacanciesDBController(ApplicationContext context)
        {
            _context = context;
        }
        ...
        // GET: VacanciesDB/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: VacanciesDB/Create
